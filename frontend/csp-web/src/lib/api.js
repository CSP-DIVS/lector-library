...
    return '/api';
  }
  // 🛑 CRITICAL FIX: Explicitly point to the backend's port 5192 in development.
  // This bypasses the need for a dev server proxy.
...
      // Log out user on a 401 response (Unauthorized)
